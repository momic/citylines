...
import org.citylines.db.station.ExpandableStationsListAdapter;
...
public class NearbyLinesFragment extends Fragment implements OnClickListener {
    ...
    private void showNearbyStations(Location loc) {
        ...
        List<Station> stations = db.getNerbyStations(loc.getLatitude(), loc.getLongitude(), NEARBY_STATIONS_COUNT);
        if (stations != null)
        {
